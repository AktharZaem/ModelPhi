...
class AppPermissionsModelTrainer:
    ...
    def train_model(self):
        ...
        # Train an SVM classifier (handles multiclass via one-vs-one internally).
        # Use class_weight='balanced' to mitigate class imbalance and probability=True to allow later probability queries.
        self.model = SVC(
        ...
        joblib.dump(self.model, 'app_permissions_svm_model.pkl')
        joblib.dump(X.columns.tolist(), 'app_permissions_feature_names.pkl')

        print("Model saved as 'app_permissions_svm_model.pkl'")
