...
def check_dependencies():
    ...
    try:
        from phishing_model_trainer import PhishingSecurityModelTrainer
    ...
    try:
        from phishing_user_tester import PhishingSecurityTester
...
def main():
    print("Phishing Security Awareness Assessment System")
    print("=" * 50)
    ...
    while True:
        ...
        print("2. Take Phishing Awareness Assessment")
        ...
        if choice == '1':
            ...
            try:
                print("Initializing phishing trainer...")
                trainer = PhishingSecurityModelTrainer(
            ...
            if not os.path.exists('phishing_security_model.pkl'):
                print("❌ Trained model not found!")
                print("Please train the model first (option 1).")
                continue

            try:
                print("Initializing phishing tester...")
                tester = PhishingSecurityTester()
                ...
                if isinstance(result, dict):
                    ...
                    print(f"\n🎓 Ready to learn more about phishing protection? Check out option 3!")
                elif isinstance(result, (int, float)):
                    last_quiz_score = result
                    print(f"\n🎓 Ready to enhance your phishing awareness? Check out option 3!")
            ...
            print("\n--- Phishing Educational Resources & Learning ---")
            try:
                if last_quiz_score is not None:
                    print(f"📊 Using your recent assessment results...")
                    education_manager.run_educational_session(last_quiz_score, weak_areas)
                else:
                ...
                print("B. Get quick phishing protection tips")
            ...
            if os.path.exists('phishing_security_model.pkl'):
                size = os.path.getsize('phishing_security_model.pkl')
                print(f"✅ phishing_security_model.pkl (size: {size} bytes)")
            else:
                print("❌ phishing_security_model.pkl not found")
            ...
            print("\nThank you for using the Phishing Security Assessment System!")
            print("Stay vigilant and protect yourself from phishing attacks! 🛡️📚")
            break
